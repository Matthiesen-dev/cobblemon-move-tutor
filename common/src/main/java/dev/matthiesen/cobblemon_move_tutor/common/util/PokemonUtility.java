...
public final class PokemonUtility {
    public static Component[] loreBuilder(Pokemon pokemon) {
        try {
            ...
            CobblemonMoveTutor.INSTANCE.createErrorLog("loreBuilder", e);
            return new Component[]{Component.translatable("cobblemon_move_tutor.gui.lore.error").withStyle(ChatFormatting.RED)};
        }
    }
    ...
    public static MutableComponent customNameBuilder(Pokemon pokemon) {
        try {
            ...
            CobblemonMoveTutor.INSTANCE.createErrorLog("customNameBuilder", e);
            return Component.literal("Unknown Pokemon").withStyle(ChatFormatting.RED);
        }
    }
    ...
    public static ItemStack pokemonToItem(Pokemon pokemon) {
        try {
            ...
            CobblemonMoveTutor.INSTANCE.createErrorLog("pokemonToItem", e);
    ...
    public static ItemStack getItemTM(MoveTemplate move) {
        try {
            ...
            CobblemonMoveTutor.INSTANCE.createErrorLog("getItemTM", e);
            return CobblemonItems.NORMAL_GEM.getDefaultInstance();
        }
    }
    ...
    public static List<MoveTemplate> getAllMoves(Learnset moves) {
        try {
            ...
            CobblemonMoveTutor.INSTANCE.createErrorLog("getAllMoves", e);
    ...
    public static boolean isLearnedMove(Pokemon pokemon, MoveTemplate move) {
        try {
            ...
            CobblemonMoveTutor.INSTANCE.createErrorLog("isLearnedMove", e);
            return false;
        }
    }
    ...
    public static int getMovePrice(Pokemon pokemon, MoveTemplate move) {
        try {
            ...
            CobblemonMoveTutor.INSTANCE.createErrorLog("getMovePrice", e);
            return 0;
        }
    }
    ...
    public static Component[] getMoveLore(Pokemon pokemon, MoveTemplate move) {
        try {
            ...
            CobblemonMoveTutor.INSTANCE.createErrorLog("getMoveLore", e);
            return new Component[]{Component.translatable("cobblemon_move_tutor.gui.lore.error").withStyle(ChatFormatting.RED)};
        }
    }
