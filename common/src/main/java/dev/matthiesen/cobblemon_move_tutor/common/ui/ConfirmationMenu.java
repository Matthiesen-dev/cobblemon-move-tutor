package dev.matthiesen.cobblemon_move_tutor.common.ui;
...
import dev.matthiesen.matthiesen_core.common.utility.ui.button.NoHighlightSlotButton;
import dev.matthiesen.matthiesen_core.common.utility.ui.button.SlotButton;
import dev.matthiesen.matthiesen_core.common.utility.ui.menu.AbstractNoInventoryMenu;
...
public final class ConfirmationMenu extends AbstractNoInventoryMenu {
    ...
    public ConfirmationMenu(int containerID, Inventory inventory,
        ...
        this.container.setItem(CANCEL_SLOT, StaticButtons.buildCancelItem());
        this.container.setItem(DETAILS_SLOT, detailsItem.copy());
        this.container.setItem(CONFIRM_SLOT, StaticButtons.buildConfirmItem());
        this.container.setItem(TITLE_SLOT, StaticButtons.buildTitleItem(ModelData.GUI_TEXT.CONFIRM_TEACH));
        addDisplaySlots();
    }
