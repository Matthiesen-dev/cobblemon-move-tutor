...
dependencies {
    add("testImplementation", "org.junit.jupiter:junit-jupiter-api:${property("junit_version")}")
    add("testRuntimeOnly", "org.junit.jupiter:junit-jupiter-engine:${property("junit_version")}")
}
